...
export class ParticleSystem {
    ...
    update = () => {
        ...
        this.particles.forEach((particle) => {
            if (particle.x > this.limit.x_max)
                particle.position.x -= this.limit.x_max
            if (particle.x < this.limit.x_min)
                particle.position.x += this.limit.x_max
            if (particle.y > this.limit.y_max)
                particle.position.y -= this.limit.y_max
            if (particle.y < this.limit.y_min)
                particle.position.y += this.limit.y_max
